...
Quickly start a Docker-based Python code execution sandbox for local development (e.g. executing code generated by your AI agent when developing locally). Made possible with `uv` and [PEP 723 – Inline script metadata](https://peps.python.org/pep-0723/).
